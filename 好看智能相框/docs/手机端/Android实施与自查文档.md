...
**关联文档**：`docs/手机端/` 下 `UI设计规范.md`、`UI视觉规格文档.md` 为完整 Design System 与逐条视觉规格，本文档为其「按页面 + 切图 + 自查」的 Android 实施摘要。
...
- **完整清单**：所有背景、圆角、边框、阴影的数值与使用场景见 **`docs/手机端/背景与圆角规格.md`**。
...
| 文件 | 说明 |
|------|------|
| `../../手机端/index.html` | 可交互 HTML 原型，所有页面与交互的参考实现（相对本文档：`docs/手机端/`） |
...
| `../../手机端/assets/icons/README.md` | 图标尺寸、用途、颜色说明 |
| `../../手机端/assets/drawables/` | 背景与圆角 drawable XML（可复制到 res/drawable） |
| `../../手机端/assets/drawables/README.md` | Drawable 清单、圆角系统、blur/阴影说明 |
| `../../手机端/assets/welcome/*.svg` | 欢迎页图标与插图 |
